...
namespace Unity_Inventory.Domain.Features.Sales
{
    ...
    {
        Task<PagedResult<ReportDTO>> GetReportsByBusinessIdAsync(PaginationRequest paginationRequest, int businessId, DateTime? startDate = null, DateTime? endDate = null);
