        ...
        <header className="h-14 bg-white border-b border-border flex items-center justify-between px-6 sticky top-0 z-40">
           <div className="flex items-center gap-4">
              <nav className="flex items-center text-xs font-medium text-zinc-400">
                <span className="hover:text-zinc-900 cursor-pointer">UnityInventory</span>
           ...
           <div className="flex items-center gap-2">
              ...
              <div className="relative" ref={notifRef}>
                <button 
                  ...
                  className={`p-1.5 rounded-md transition-all ${isNotifOpen ? 'bg-zinc-100 text-zinc-900' : 'text-zinc-400 hover:text-zinc-900 hover:bg-zinc-50'}`}
                >
                  <Bell size={16} />
                </button>

                {isNotifOpen && (
                  <div className="absolute right-0 top-full mt-2 w-80 bg-white border border-zinc-200 rounded-xl shadow-2xl shadow-zinc-200/50 overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200 z-50">
                    <div className="flex items-center justify-between px-4 py-3 border-b border-zinc-100">
                      <h3 className="text-xs font-bold text-zinc-900 uppercase tracking-wider">Notifications</h3>
              ...
              <div className="relative" ref={actionRef}>
                ...
                {isActionOpen && (
                  <div className="absolute right-0 top-full mt-2 w-64 bg-white border border-zinc-200 rounded-xl shadow-2xl shadow-zinc-200/50 overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200 z-50">
                    <div className="px-4 py-3 border-b border-zinc-100">
                      <h3 className="text-xs font-bold text-zinc-900 uppercase tracking-wider">Quick Actions</h3>
                    ...
                    <div className="py-1">
                      {quickActions.map((action) => (
                        <button
                          ...
                          className="w-full flex items-center gap-3 px-4 py-2.5 hover:bg-zinc-50 transition-colors text-left group"
                        >
                          <div className="w-8 h-8 rounded-lg bg-zinc-100 flex items-center justify-center group-hover:bg-zinc-900 group-hover:text-white text-zinc-400 transition-all shrink-0">
                            <action.icon size={14} />
                          </div>
