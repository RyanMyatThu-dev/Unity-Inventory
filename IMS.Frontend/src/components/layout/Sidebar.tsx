    ...
    <div className="flex flex-col w-64 bg-[#FAFAFA] border-r border-border h-screen sticky top-0 transition-all z-50">
      ...
      <div className="h-14 flex items-center px-4 border-b border-border justify-between bg-white">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-semibold text-zinc-900 tracking-tight">IMS Pro</span>
        </div>
      ...
      <div className="p-3 border-t border-border bg-white">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2 min-w-0">
            <div className="w-8 h-8 rounded-full bg-zinc-100 flex items-center justify-center text-zinc-500 border border-border shrink-0">
          ...
          <button onClick={logout} className="p-1.5 text-zinc-400 hover:text-rose-500 transition-colors">
            <Settings size={14} />
          </button>
        </div>
      </div>
